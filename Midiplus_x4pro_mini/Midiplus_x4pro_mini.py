...
class Midiplus_x4pro_mini(ControlSurface):
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in Midiplus_x4pro_mini._active_instances:
    ...
    def _do_combine(self):
        if self not in Midiplus_x4pro_mini._active_instances:
            Midiplus_x4pro_mini._active_instances.append(self)
            Midiplus_x4pro_mini._combine_active_instances()


    def _do_uncombine(self):
        if ((self in Midiplus_x4pro_mini._active_instances) and Midiplus_x4pro_mini._active_instances.remove(self)):
